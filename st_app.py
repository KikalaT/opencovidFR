...
'Nombre de décès (cumulé)', df_france.tail(1)['deces'][0]
...
'Données calculées le :', date.today()
'Nombre de décès (cumulé)', df_area.tail(1)['deces'][0]
'Nouvelles hospitalisations', df_area.tail(1)['nouvelles_hospitalisations'][0]
'Nouvelles réanimations', df_area.tail(1)['nouvelles_reanimations'][0]
...
# st display
st.line_chart(df_area[['nouvelles_hospitalisations','nouvelles_reanimations']].tail(10))
...
# graph1 : ['deces','hospitalises']
st.line_chart(df_area[['deces','hospitalises']])
...
# graph2 : ['reanimation']
df_area = df[df['maille_nom'] == area]
st.line_chart(df_area[['reanimation']])
